...
class s_update extends StatelessWidget {
  ...
  void updatedata(String col, String sl, String shw, String sln, String sll,
      String chest, String waist, String sw, String cuff, String hw) {
    Firestore.instance
        .collection("custData")
        .document(shup.data['cName'])
        .updateData({
      'col': col,
      'sl': sl,
      'shw': shw,
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    RaisedButton(
                      ...
                      onPressed: () {
                        if (save()) {
                          updatedata(col, sl, shw, sln, sll, chest, waist, sw,
                              cuff, hw);
